...
mutation MyMutation($author_id: Int!, $name: String!, $user_id: String!, $image_url: String!) {
    insert_Books_one(object: {author_id: $author_id, name: $name, user_id: $user_id, image_url: $image_url}) {
      id
    }
  }
`;